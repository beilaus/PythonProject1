...
# Work and approach:
-Used windows, researched for a viable dataset of cones, installed all the required applications for the suitable environment. Proceeded to install the ai model.<br />
